...
GitSense brings advanced search capability and code management metrics to GitHub and GitHub Enterprise.  With GitSense, you'll be able to search for commits, a feature many GitHubbers have longed for.  Code searches are also no longer limited to non-forked repositories and so much more.  For a more detailed description on how GitSense is reimaging GitHub browsing, make sure to visit http://gitsense.github.io for more information.
